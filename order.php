...
<section class="content container-fluid">
    <div class="box box-success">
        <div class="box-header with-border">
            ...
            //echo "AAAAAAAjdjdjdj  ".$_SESSION['reste']."iiiii";
            ...
            ?>
                ...
                <a href="create_order.php" class="btn btn-success btn-sm pull-right">Nouvelle Transaction</a>
                    ...
                    <tbody>
                        ...
                        if (isset($_POST['date_filter'])) {
                            ...
                            if ($_SESSION['role'] == "Admin" && $leshop != "all") {
                                $select = $pdo->prepare("SELECT * FROM tbl_invoice WHERE cashier_name IN (SELECT username FROM tbl_user WHERE magasin = '$leshop' ) AND  order_date BETWEEN :fromdate AND :todate ORDER BY invoice_id");
                            } elseif ($_SESSION['role'] == "Admin" && $leshop == "all") {

                                $select = $pdo->prepare("SELECT * FROM tbl_invoice WHERE order_date BETWEEN :fromdate AND :todate ORDER BY invoice_id");
                            } else {
                                $select = $pdo->prepare("SELECT * FROM tbl_invoice WHERE (order_date BETWEEN :fromdate AND :todate) AND cashier_name IN (SELECT username FROM tbl_user WHERE magasin = '$magasin' )  ORDER BY invoice_id");
                            }
                        ...
                        <?php
                            ...
                            if ($_SESSION['role'] == "Admin") {
                                ...
                                $select = $pdo->prepare("SELECT * FROM tbl_invoice WHERE cashier_name IN (SELECT username FROM tbl_user WHERE magasin = '$magasin') ORDER BY invoice_id DESC");
                            }
                        }
