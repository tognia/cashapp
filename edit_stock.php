                ...
                <div class="box-body">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            name="shop_code" value="<?php //echo $shopCode_db; 
                                                    ?>" required readonly> -->
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="product_name" value="<?php echo $productName_db; ?>" required readonly>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            ?>
                            STOCK <input type="number" min="0" step="1" class="form-control" name="" value="<?php echo $stock_db; ?>" required readonly>
                        </div>
                        <div>
                            <span class="badge badge-info">
                                QUANTITE STOCK &nbsp; A &nbsp; AJOUTER</span>
                            <input type="number" min="1" step="1" class="form-control" name="stock" value="<?php //echo $stock_db; 
                                                                                                            ?>" required>

                        </div>
                        <div class="form-group">
                            <label for="">Stock Minimal</label>
                            <input type="number" min="1" step="1" class="form-control" name="min_stock" value="<?php echo $min_stock_db; ?>" required readonly>
                        </div>
                        <div class="form-group">
                            <label for="">Unite</label>
                            <input type="text" class="form-control" name="satuan" value="<?php echo $satuan_db; ?>" required readonly>

                        </div>

                        <div class="form-group">
                            <label for="">Categorie</label>
                            <input type="text" class="form-control" name="category" value="<?php echo $category_db; ?>" required readonly>

                        </div>

                        <div class="form-group">
                            <label for="">Marque</label>
                            <input type="text" class="form-control" name="product_brand" value="<?php echo $productBrand_db; ?>" required readonly>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min="10" class="form-control" name="purchase_price" value="<?php echo $purchase_db; ?>" required readonly>
                        </div>
                        <div class="form-group">
                            <label for="">Prix de vente</label>
                            <input type="number" min="100" class="form-control" name="sell_price" value="<?php echo $sell_db; ?>" required readonly>
                        </div>
                        <div class="form-group">
                            <label for="">Prix Min</label>
                            <input type="text" min="100" class="form-control" name="min_price" value="<?php echo $min_db; ?>" required readonly>
                        </div>
                        <div class="form-group">
                            <label for="">Discount</label>
                            <input type="text" class="form-control" name="discount" value="<?php echo $discount_db; ?>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description" cols="30" rows="10" class="form-control" required readonly><?php echo $desc_db; ?></textarea>
                        </div>
                    </div>
