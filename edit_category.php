...
if (isset($_POST['btn_edit'])) {
  ...
  $update = $pdo->prepare("UPDATE tbl_category SET cat_name='$category_name', cat_parent ='$categoryparent', cat_level = '$level'  WHERE cat_id='" . $_GET['id'] . "' ");
  ...
  if ($update->execute()) {
    ...
    echo '<script type="text/javascript">
        jQuery(function validation(){
        swal("Success", "Categorie Mise a jour", "success", {
        button: "Continue",
            });
        });
        </script>';
      ...
      <div class="box box-warning">
        ...
        <form action="" method="POST">
          <div class="box-body">
            ...
            <div class="form-group">
              <label for="">Categorie Parent</label>
              <select class="form-control" name="categoryparent" required>
                <option selected="selected"><?php echo $cat_parent; ?></option>
            ...
            <div class="form-group">
              <label>Niveau categorie</label>
              <select class="form-control" name="level" required>
                <option selected="selected"><?php echo $cat_level; ?></option>
                <option>1</option>
                <option>2</option>
                <option>3</option>
                <option>4</option>
    ...
    <div class="col-md-8">
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Liste Categorie</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
