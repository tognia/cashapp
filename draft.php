   ...
   if($_SESSION['user_name']==""){
    ...
    if(isset($_POST['save_order'])){
      ...
      if($arr_product_code == ""){
        ...
        $insert = $pdo->prepare("INSERT INTO tbl_invoice(cashier_name, id_client, order_date, time_order, total, paid, due)
        values(:name, :id_client, :orderdate, :timeorder, :total, :paid, :due)");
  ...
  //Date picker
    ...
    $(document).ready(function(){
      $(document).on('click','.btn_addOrder', function(){
        ...
        html+='<td><select class="form-control productid" name="productid[]" style="width:100px;"><option value="">--Select Product--</option><?php
    ...
    html+='<td><input type="text" class="form-control productname" style="width:200px;" name="productname[]" readonly></td>';
        html+='<td><input type="text" class="form-control productstock" style="width:50px;" name="productstock[]" required readonly></td>';
