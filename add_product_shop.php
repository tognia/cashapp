        ...
        if(isset($_POST['product_code'])){
            ...
            elseif (strlen($code)>15)

             {
                    echo'<script type="text/javascript">
                    jQuery(function validation(){
                    swal("Le code doit avoir au plus 15 caracteres", "warning", {
                    button: "Continue",
                        });
                    });
                    </script>';
                ...
                if($img_size>= 1000000){
                    ...
                    if(move_uploaded_file($img_tmp,$store)){
                        ...
                        if(!isset($error)){
                            ...
                            $insert = $pdo->prepare("INSERT INTO tbl_product(product_code,product_sku,product_name,product_category,product_brand,purchase_price,sell_price,min_price,discount,stock,min_stock,product_satuan,supplier,description,img)
                            values(:product_code,:product_sku,:product_name,:product_category,:product_brand,:purchase_price,:sell_price,:min_price,:discount,:stock,:min_stock,:satuan,:supplier,:desc1,:img)");
                        ...
                        $select1 = $pdo->prepare("SELECT * FROM agence");
                                ...
                                $insert_item = $pdo->prepare("INSERT INTO tbl_shop_item(shop_code,product_code,product_sku,product_name,product_category,product_brand,purchase_price,sell_price,min_price,discount,stock,min_stock,product_satuan,supplier,description,img)
                            values(:shop,:product_code,:product_sku,:product_name,:product_category,:product_brand,:purchase_price,:sell_price,:min_price,:discount,:stock,:min_stock,:satuan,:supplier,:desc1,:img)");
        ...
        <div class="box box-success">
            ...
            <form action="" method="POST" name="form_product"
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <img id="img_preview" src="upload/60793c4660233.png<?php //echo $row->img?>" alt="Preview" class="img-responsive" />
                        </div>
                    </div>
                </div>
                ...
                <div class="box-footer">
                    ...
                    name="add_product">Enregistrer Produit</button>
