        ...
        <div class="box-body">
          ...
          if (isset($_POST['date_filter'])) {
            ...
            if ($_SESSION['role'] == "Admin" && $leshop == "all") {
              ...
              $select = $pdo->prepare("SELECT sum(total) as total, count(invoice_id) as invoice FROM tbl_invoice
                    WHERE user_login IN (SELECT username FROM tbl_user WHERE magasin = '$leshop' ) AND order_date BETWEEN :fromdate AND :todate");
              $select->bindParam(':fromdate', $_POST['date_1']);
              $select->bindParam(':todate', $_POST['date_2']);
            } else {
              ...
              $select = $pdo->prepare("SELECT sum(total) as total, count(invoice_id) as invoice FROM tbl_invoice
                    WHERE user_login IN (SELECT username FROM tbl_user WHERE magasin = '$mgs' ) AND order_date BETWEEN :fromdate AND :todate");
              $select->bindParam(':fromdate', $_POST['date_1']);
              $select->bindParam(':todate', $_POST['date_2']);
            }
          }
          ...
          elseif ($_SESSION['role'] == "Admin") {
            ...
            $select = $pdo->prepare("SELECT sum(total) as total, count(invoice_id) as invoice FROM tbl_invoice
                    WHERE user_login IN (SELECT username FROM tbl_user WHERE magasin = '$mgs' )");
          }
            ...
            <div class="col-md-offset-2 col-md-4 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">TOTAL TRANSACTIONS SUR LA PERIODE </span>
