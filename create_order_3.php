...
<style>
  /* Responsive Styles for Transaction Caisse */
  ...
  @media (max-width: 768px) {
    ...
    #myOrder {
      min-width: 900px;
      /* Minimum width to maintain table structure */
      font-size: 12px;
    }
    ...
    #myOrder .form-control.productSearch {
      width: 180px !important;
    }

    #myOrder .form-control.productcode {
      width: 80px !important;
    }

    #myOrder .form-control.productname {
      width: 150px !important;
    }

    #myOrder .form-control.productstock {
      width: 40px !important;
    }

    #myOrder .form-control.productprice {
      width: 70px !important;
    }

    #myOrder .form-control.productmin {
      width: 70px !important;
    }

    #myOrder .form-control.discount {
      width: 35px !important;
    }

    #myOrder .form-control.remise {
      width: 50px !important;
    }

    #myOrder .form-control.quantity_product {
      width: 50px !important;
    }

    #myOrder .form-control.productsatuan {
      width: 35px !important;
    }

    #myOrder .form-control.producttotal {
