              ...
              <?php
                ...
                <div class="col-md-6">
                  <ul class="list-group">
                    ...
                    <center><p class="list-group-item list-group-item-success">Detail Produit</p></center>
                    ...
                    <li class="list-group-item"><b>Place In Storeroom</b>        :<span class="label label-primary pull-right"><?php echo $row->place_in_storeroom; ?></span></li>
                     <li class="list-group-item"><b>Place In Retail Store</b>        :<span class="label label-primary pull-right"><?php echo $row->place_in_store; ?></span></li>
                ...
                <div class="col-md-6">
                  <ul class="list-group">
                    <center><p class="list-group-item list-group-item-success">Image</p></center>
