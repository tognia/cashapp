        ...
        <div class="box box-success">
            ...
            <div class="box-header with-border">
                <div class="pull-right">
                    ...
                    <a href="manage_damage.php" class="btn btn-danger btn-sm">
                        <i class="fa fa-file-text-o"></i> Rapport Domages
                    </a>
                </div>
            </div>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if ($_SESSION['role'] == "Admin" || $_SESSION['role'] == "storekeeper") { ?>
                                        <a href="add_damage.php?id=<?php echo $row->product_id; ?>&shop=<?php echo $shop; ?>" class="btn btn-danger btn-xs">
                                            <button class="btn btn-warning btn-xs edit-transit-btn"
                                                title="Enregistrer Incident">
