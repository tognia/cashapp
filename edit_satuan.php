...
if(isset($_POST['btn_edit'])){
      ...
      if($update->rowCount() > 0){
        ...
        swal("Warning", "Echec Modifications", "warning", {
        button: "Continue",
            });
        });
        </script>';
        ...
        echo'<script type="text/javascript">
        jQuery(function validation(){
        swal("Success", "Modifications Prises en compte", "success", {
        button: "Continue",
            });
        });
        </script>';
                ...
                <form action="" method="POST">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="category">Libelle Unite Produit</label>
                  ...
                  <div class="box-footer">
                      ...
                      <a href="satuan.php" class="btn btn-warning">Retour</a>
                  </div>
                </form>
            </div>
      </div>
      ...
      <div class="col-md-8">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Liste Unites Produits</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
