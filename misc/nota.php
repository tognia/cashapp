...
$pdf->Image('../images/logo.jpg', 30, 5, 20, 10);
...
$pdf->SetFont('Arial','',3);
$pdf->Cell(63,2,'Vente de materiel electrique et interieur maison',0,1,'C');

$pdf->SetFont('Arial','',3);
$pdf->Cell(63,2,'Tel. 00237 621 10 05 00 (BVLC)',0,1,'C');
